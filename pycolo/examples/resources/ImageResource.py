...
class ImageResource(LocalResource):
    ...
    def __init___0(self, resourceIdentifier):
        ...
        self.supported.append(mediaTypeRegistry["IMAGE_PNG"])
        self.supported.append(mediaTypeRegistry["IMAGE_JPEG"])
        self.supported.append(mediaTypeRegistry["IMAGE_GIF"])
        self.supported.append(mediaTypeRegistry["IMAGE_TIFF"])
